                ...
                <?php
                    ...
                    if( $myposts ){
                        foreach( $myposts as $post ){
                            ...
                            <div class="spravka">
                                        <div class="spravka-img">
                                        <?php the_post_thumbnail() ?>
                                        </div>
                                        <div class="spravka-title">
                                            <?php the_title(); ?>
                                        </div>
                                        <div class="spravka-text">
                                        <?php the_content() ?>
                                        </div>
                                        <div class="site_form-btn spravka-btn">
                                            <a href="#buy_spavka">Заказать справку</a>                                            </div>
                                        </div>
                            <?php 
                        }
                    } 
